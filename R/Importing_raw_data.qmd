...
mutation <- read.delim(file.path(folder, "tmb_mskcc_2018/data_mutations.txt"), sep = "\t", header = TRUE)
...
```{r}
data_mutation_without_nas <- mutations |> 
...
patients_sample_gene_panel|>
  write_tsv(file = here('data','patient_sample_gene_panel'))
```
