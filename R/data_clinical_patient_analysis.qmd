...
patients |>
  ...
  geom_boxplot()+
  facet_wrap(~ Sex)+
  labs(title = 'Box Plot of the Drug success rate based on the proportion of patients still alive vs dead with the same drug', fill = 'Status')+
