...
```{r}
patients_sample_gene_panel <- read_delim(here("data", "patient_sample_gene_panel"), delim = "\t", show_col_types = FALSE)
```
...
# html saving to results

```{r}
rmarkdown::render(
  input = "data_clinical_patient_analysis.qmd",
  output_file = "../results/data_clinical_patient_analysis.html"
)
```
