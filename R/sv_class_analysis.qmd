...
Density plot + histogram overlapped
...
Are there other SVs in glioma samples ?
...
glioma_SV |> 
  ggplot(aes(x = Site1_Hugo_Symbol, fill = Class)) +
  geom_bar(color = "black", alpha = 0.8) +
  coord_flip() +
  theme_minimal() 

glioma_SV |> 
  ggplot(aes(x = Site2_Hugo_Symbol, fill = Class)) +
  geom_bar(color = "black", alpha = 0.8) +
  coord_flip() +
  theme_minimal() 
```

### Study of mutations for glioma sample
